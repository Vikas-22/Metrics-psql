namespace Metrices_API.PrometheusQueryServices

{
...

    {
        ...
        static Counter TotalIndexReach = Metrics.CreateCounter("Total_index_page_reached", "Total_request_got_for_index");
